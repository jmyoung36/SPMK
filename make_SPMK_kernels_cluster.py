# -*- coding: utf-8 -*-
"""
Created on Mon Feb 29 11:16:43 2016
...
all_image_data = np.zeros((len(IXI_metadata), 9764864))
...
#                
#        # save kernels
#        np.savetxt(kernel_dir + 'SPMK_intersection_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_2.csv', K_histogram_intersection, delimiter=',')
#        np.savetxt(kernel_dir + 'SPMK_bhattacharyya_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_2.csv', K_bhattacharyya, delimiter=',')
#        np.savetxt(kernel_dir + 'SPMK_lin_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_2.csv', K_SPMK_lin, delimiter=',')
...
#                    K_bhattacharyya[start_ind_1:stop_ind_1, start_ind_2:stop_ind_2] = SPMK_3d.bhattacharyya_coefficient_kernel_2(histogram_data_1, histogram_data_2, False)
        ...
        # save kernels
#        np.savetxt(kernel_dir + 'SPMK_intersection_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_3.csv', K_histogram_intersection, delimiter=',')
#        np.savetxt(kernel_dir + 'SPMK_bhattacharyya_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_3.csv', K_bhattacharyya, delimiter=',')
#        np.savetxt(kernel_dir + 'SPMK_lin_' + str(n_intensity_levels) + '_' + str(n_histogram_levels) + '_3.csv', K_SPMK_lin, delimiter=',')                